...
export function layoutCssVariables(
    layout: LayoutConfig,
    ...
    const identityTop =
        layout.identityBand.bottomInches - layout.identityBand.heightInches;
    ...
    const holeTop =
        layout.fingerHole.topInches + (holeHeight - guideHeight) / 2;

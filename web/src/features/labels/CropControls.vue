...
<template>
    <section
        class="crop-controls"
        :aria-label="`Crop controls for ${label.id}`"
    >
        <div>
            <div class="crop-controls-title">Crop</div>
            <div class="crop-controls-help">
                Left/middle drag to pan · Ctrl/Cmd + scroll to zoom
            </div>
        </div>
        ...
        <button
            type="button"
            :disabled="
                !catalog.isSaveAvailable ||
                catalog.isSaving ||
                catalog.isCropSaved(label.id)
            "

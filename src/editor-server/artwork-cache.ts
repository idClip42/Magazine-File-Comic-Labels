...
export const legacyArtworkCacheDirectory = path.join(process.cwd(), "dist", "artwork-cache");
export const artworkCacheDirectory = path.join(process.cwd(), ".cache", "artwork");
 ...
 */
export function migrateLegacyArtworkCache(): "migrated" | "already-migrated" | "not-found" {
...
export async function loadArtworkFromDiskCache(asset: string): Promise<boolean> {
...
export function saveArtworkToDiskCache(asset: string, image: CachedImage): void {

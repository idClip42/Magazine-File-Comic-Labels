...
import type { EditorUpdates, ArtUpdate, CropUpdate, LayoutUpdate } from "../core/editor-updates";
...
export function assertEditorUpdates(value: unknown): asserts value is EditorUpdates {
    if (!value || typeof value !== "object" || Array.isArray(value)) {
        throw new Error("Expected editor changes to be an object.");
    }
    const updates = value as EditorUpdates;
    if (updates.arts !== undefined
...
export function saveChanges(updates: EditorUpdates): { arts: number; layout: number } {
